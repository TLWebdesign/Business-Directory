...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		BusinessdirectoryInstallerScript.php
...
/**
 * Script File of Businessdirectory Component
 *
 * @since  3.6
 */
class Com_BusinessdirectoryInstallerScript implements InstallerScriptInterface
{
	/**
	 * The CMS Application.
	 *
	...
	public function __construct()
	{
		...
		if (is_file(JPATH_ROOT . '/administrator/components/com_businessdirectory/businessdirectory.php'))
		{
			// remove Joomla 3 files
			$this->deleteFiles = [
				'/administrator/components/com_businessdirectory/businessdirectory.php',
				'/administrator/components/com_businessdirectory/controller.php',
				'/components/com_businessdirectory/businessdirectory.php',
				'/components/com_businessdirectory/controller.php',
				'/components/com_businessdirectory/router.php',
			];
		}

		// check if the Folders exist
		if (is_dir(JPATH_ROOT . '/administrator/components/com_businessdirectory/modules'))
		{
			// remove Joomla 3 folder
			$this->deleteFolders = [
				'/administrator/components/com_businessdirectory/controllers',
				'/administrator/components/com_businessdirectory/helpers',
				'/administrator/components/com_businessdirectory/modules',
				'/administrator/components/com_businessdirectory/tables',
				'/administrator/components/com_businessdirectory/views',
				'/components/com_businessdirectory/controllers',
				'/components/com_businessdirectory/helpers',
				'/components/com_businessdirectory/modules',
				'/components/com_businessdirectory/views',
			];
		}
	}
	...
	public function uninstall(InstallerAdapter $adapter): bool
	{
		...
		// Remove Company Data
		$this->removeViewData("com_businessdirectory.company");

		// Remove Country Data
		$this->removeViewData("com_businessdirectory.country");

		// Remove State Data
		$this->removeViewData("com_businessdirectory.state");
		...
		$this->removeActionLogConfig('com_businessdirectory.company');

		// Remove Country from action logs config table.
		$this->removeActionLogConfig('com_businessdirectory.country');

		// Remove State from action logs config table.
		$this->removeActionLogConfig('com_businessdirectory.state');
		...
		<p>Please let me know at <a href="mailto:info@tlwebdesign.nl">info@tlwebdesign.nl</a>.
		<br />We at TLWebdesign are committed to building extensions that performs proficiently! You can help us, really!
		<br />Send me your thoughts on improvements that is needed, trust me, I will be very grateful!
		<br />Visit us at <a href="https://tlwebdesign.nl" target="_blank">https://tlwebdesign.nl</a> today!</p></div>';
	...
	public function postflight(string $type, InstallerAdapter $adapter): bool
	{
		...
		if ($type === 'install')
		{
			...
			$this->setContentType(
				// typeTitle
				'Businessdirectory Company',
				// typeAlias
				'com_businessdirectory.company',
				// table
				'{"special": {"dbtable": "#__businessdirectory_company","key": "id","type": "CompanyTable","prefix": "JCB\Component\Businessdirectory\Administrator\Table"}}',
				// rules
				'',
				// fieldMappings
				'{"common": {"core_content_item_id": "id","core_title": "name","core_state": "published","core_alias": "null","core_created_time": "created","core_modified_time": "modified","core_body": "null","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "metadata","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "metakey","core_metadesc": "metadesc","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"name":"name","city":"city","country":"country","contactname":"contactname","guid":"guid","website":"website","phone":"phone","email":"email","expertise":"expertise","companysize":"companysize","state":"state","coc":"coc","zip":"zip","address":"address"}}',
				// router
				'',
				// contentHistoryOptions
				'{"formFile": "administrator/components/com_businessdirectory/forms/company.xml","hideFields": ["asset_id","checked_out","checked_out_time"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "country","targetTable": "#__businessdirectory_country","targetColumn": "guid","displayColumn": "name"},{"sourceColumn": "state","targetTable": "#__businessdirectory_state","targetColumn": "guid","displayColumn": "name"}]}'
			);
			// Install Country Content Types.
			$this->setContentType(
				// typeTitle
				'Businessdirectory Country',
				// typeAlias
				'com_businessdirectory.country',
				// table
				'{"special": {"dbtable": "#__businessdirectory_country","key": "id","type": "CountryTable","prefix": "JCB\Component\Businessdirectory\Administrator\Table"}}',
				// rules
				'',
				// fieldMappings
				'{"common": {"core_content_item_id": "id","core_title": "name","core_state": "published","core_alias": "null","core_created_time": "created","core_modified_time": "modified","core_body": "null","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "metadata","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "metakey","core_metadesc": "metadesc","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"name":"name","guid":"guid"}}',
				// router
				'',
				// contentHistoryOptions
				'{"formFile": "administrator/components/com_businessdirectory/forms/country.xml","hideFields": ["asset_id","checked_out","checked_out_time"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"}]}'
			);
			// Install State Content Types.
			$this->setContentType(
				// typeTitle
				'Businessdirectory State',
				// typeAlias
				'com_businessdirectory.state',
				// table
				'{"special": {"dbtable": "#__businessdirectory_state","key": "id","type": "StateTable","prefix": "JCB\Component\Businessdirectory\Administrator\Table"}}',
				// rules
				'',
				// fieldMappings
				'{"common": {"core_content_item_id": "id","core_title": "name","core_state": "published","core_alias": "null","core_created_time": "created","core_modified_time": "modified","core_body": "null","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "metadata","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "metakey","core_metadesc": "metadesc","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"name":"name","country":"country","guid":"guid"}}',
				// router
				'',
				// contentHistoryOptions
				'{"formFile": "administrator/components/com_businessdirectory/forms/state.xml","hideFields": ["asset_id","checked_out","checked_out_time"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "country","targetTable": "#__businessdirectory_country","targetColumn": "guid","displayColumn": "name"}]}'
			);


			// Fix the assets table rules column size.
			$this->setDatabaseAssetsRulesFix(7520, "TEXT");
			// Install the global extension params.
			$this->setExtensionsParams(
				'{"autorName":"Tom van der Laan","autorEmail":"info@tlwebdesign.nl","check_in":"-1 day","save_history":"1","history_limit":"10"}'
			);


			echo '<div style="background-color: #fff;" class="alert alert-info"><a target="_blank" href="https://tlwebdesign.nl" title="Business Directory">
				<img src="components/com_businessdirectory/assets/images/vdm-component.jpg"/>
				</a></div>';
			...
			$this->setActionLogConfig(
				...
				'name',
				// tableName
				'#__businessdirectory_company',
				// textPrefix
				'COM_BUSINESSDIRECTORY'
			);
		...
		if ($type === 'update')
		{
			...
			echo '<div style="background-color: #fff;" class="alert alert-info"><a target="_blank" href="https://tlwebdesign.nl" title="Business Directory">
				...
				<h3>Upgrade to Version 1.0.2 Was Successful! Let us know if anything is not working as expected.</h3></div>';
	...
	protected function setActionLogsExtensions(): void
	{
		...
		$data = new stdClass();
		$data->extension = 'com_businessdirectory';

		// Check if businessdirectory action log extension is already in action logs extensions DB.
		$query = $this->db->getQuery(true);
		$query->select($this->db->quoteName(['id']));
		...
		if ($this->db->getNumRows())
		{
			...
			$this->app->enqueueMessage(
				Text::_('The (com_businessdirectory) is already in the <b>#__action_logs_extensions</b> table.')
			);
		}
		elseif ($this->db->insertObject('#__action_logs_extensions', $data))
		{
			...
			$this->app->enqueueMessage(
				Text::_('The (com_businessdirectory) was successfully added to the <b>#__action_logs_extensions</b> table.')
			);
		}
	}
	...
	protected function setAssetsRules(string $rules): void
	{
		// Condition.
		$conditions = [
			$this->db->quoteName('name') . ' = ' . $this->db->quote('com_businessdirectory')
		];
		...
		if ($done)
		{
			// give a success message
			$this->app->enqueueMessage(
				Text::_('The (com_businessdirectory) rules was successfully added to the <b>#__assets</b> table.')
			);
		}
	}
	...
	protected function setExtensionsParams(string $params): void
	{
		// Condition.
		$conditions = [
			$this->db->quoteName('element') . ' = ' . $this->db->quote('com_businessdirectory')
		];
		...
		if ($done)
		{
			// give a success message
			$this->app->enqueueMessage(
				Text::_('The (com_businessdirectory) params was successfully added to the <b>#__extensions</b> table.')
			);
		}
	}
	 ...
	 *
	 * @param   int     $accessWorseCase   This is the max rules column size com_businessdirectory would needs.
	...
	protected function setDatabaseAssetsRulesFix(int $accessWorseCase, string $dataType): void
	{
		...
		if ($this->db->execute())
		{
			...
			{
				// Fix the assets table rules column size
				$fix = "ALTER TABLE `#__assets` CHANGE `rules` `rules` {$dataType} NOT NULL COMMENT 'JSON encoded access control. Enlarged to {$dataType} by Businessdirectory';";
	...
	{
		// Remove businessdirectory view from the action_log_config table
		$condition = [
			$this->db->quoteName('type_alias') . ' = '. $this->db->quote($context)
		];
		...
		// Execute the query to remove com_businessdirectory.view
		$done = $this->db->execute();
		if ($done)
		{
			// If successfully removed businessdirectory view add queued success message.
			$this->app->enqueueMessage(
	...
	{
		// Remove businessdirectory assets from the assets table
		$condition = [
			$this->db->quoteName('name') . ' LIKE ' . $this->db->quote('com_businessdirectory.%')
		];
		...
		if ($done)
		{
			// If successfully removed businessdirectory add queued success message.
			$this->app->enqueueMessage(
				Text::_('All related (com_businessdirectory) items was removed from the <b>#__assets</b> table.')
			);
		}
	}
	...
	{
		// Remove businessdirectory from the action_logs_extensions table
		$extension = [
			$this->db->quoteName('extension') . ' = ' . $this->db->quote('com_businessdirectory')
		];
		...
		// Execute the query to remove businessdirectory
		$done = $this->db->execute();
		if ($done)
		{
			// If successfully remove businessdirectory add queued success message.
			$this->app->enqueueMessage(
				Text::_('The (com_businessdirectory) extension was removed from the <b>#__action_logs_extensions</b> table.')
			);
		}
	}
	...
	protected function classExists(string $className): bool
	{
		...
		$autoloaders = [
			__DIR__ . '/BusinessdirectoryInstallerPowerloader.php',
			JPATH_ADMINISTRATOR . '/components/com_businessdirectory/src/Helper/PowerloaderHelper.php'
		];
