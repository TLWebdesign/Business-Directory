...
/** @var \JCB\Component\Businessdirectory\Administrator\View\Companies\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_businessdirectory&view=companies&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
