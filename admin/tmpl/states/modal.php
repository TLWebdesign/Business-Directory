...
/** @var \JCB\Component\Businessdirectory\Administrator\View\States\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_businessdirectory&view=states&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
