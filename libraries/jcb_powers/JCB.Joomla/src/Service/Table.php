...
use JCB\Joomla\Businessdirectory\Table as DataTable;
use JCB\Joomla\Businessdirectory\Table\Schema;
use JCB\Joomla\Businessdirectory\Table\Validator;
...
/***[JCBGUI.power.main_class_code.762.$$$$]***/
	...
	/**
	 * Get The Businessdirectory Data Table Class.
	 *
	 * @param   Container  $container  The DI container.
	 *
	 * @return  DataTable
