...
/------------------------------------------------------------------------------------------------------*/
namespace JCB\Component\Businessdirectory\Administrator\View\Countries;
...
/**
 * Businessdirectory Html View class for the Countries
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	{
		ToolbarHelper::title(Text::_('COM_BUSINESSDIRECTORY_COUNTRIES'), 'joomla');
		...
		$this->help_url = BusinessdirectoryHelper::getHelpUrl('countries');
	...
	protected function _prepareDocument(): void
	{
		...
		$this->getDocument()->setTitle(Text::_('COM_BUSINESSDIRECTORY_COUNTRIES'));
		// add styles
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_BUSINESSDIRECTORY_COUNTRY_NAME_LABEL'),
