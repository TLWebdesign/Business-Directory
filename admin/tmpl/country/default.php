...
<?php echo LayoutHelper::render('country.states_above', $this); ?>
<div class="main-card">

	<?php echo Html::_('uitab.startTabSet', 'countryTab', ['active' => 'states', 'recall' => true]); ?>

	<?php echo Html::_('uitab.addTab', 'countryTab', 'states', Text::_('COM_BUSINESSDIRECTORY_COUNTRY_STATES', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'countryTab', 'publishing', Text::_('COM_BUSINESSDIRECTORY_COUNTRY_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
				<?php echo LayoutHelper::render('country.publishing', $this); ?>
			</div>
			<div class="col-md-6">
				<?php echo LayoutHelper::render('country.metadata', $this); ?>
			</div>
		</div>
	<?php echo Html::_('uitab.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('uitab.addTab', 'countryTab', 'permissions', Text::_('COM_BUSINESSDIRECTORY_COUNTRY_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
				<fieldset id="fieldset-rules" class="options-form">
					<legend><?php echo Text::_('COM_BUSINESSDIRECTORY_COUNTRY_PERMISSION'); ?></legend>
					<div>
