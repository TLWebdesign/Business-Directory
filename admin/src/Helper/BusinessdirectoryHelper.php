...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		BusinessdirectoryHelper.php
...
/------------------------------------------------------------------------------------------------------*/
namespace JCB\Component\Businessdirectory\Administrator\Helper;

// The power autoloader for this project (JPATH_ADMINISTRATOR) area.
$power_autoloader = JPATH_ADMINISTRATOR . '/components/com_businessdirectory/src/Helper/PowerloaderHelper.php';
 ...
 * @since   3.0
 */
abstract class BusinessdirectoryHelper
{
	/**
	 * Composer Switch
	 *
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_businessdirectory/businessdirectory.xml";
	...
	{
		// get params
		$params    = ComponentHelper::getParams('com_businessdirectory');
	...
	public static function addSubmenu($submenu)
	{
		...
		\JHtmlSidebar::addEntry(Text::_('COM_BUSINESSDIRECTORY_SUBMENU_DASHBOARD'), 'index.php?option=com_businessdirectory&view=businessdirectory', $submenu === 'businessdirectory');
	}
	 ...
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'businessdirectory')
	{
	 ...
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'businessdirectory', $unique = true)
	{
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__businessdirectory_'.$type.' AS a');
	 ...
	 *
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'businessdirectory', $user = 'null')
	{
	...
	public static function getModel(string $type, string $prefix = 'Administrator',
		string $component = 'businessdirectory', array $config = [])
	{
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_businessdirectory');

		$parentId = $parent->id;
		$name     = 'com_businessdirectory.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_businessdirectory', $table, $inherit);
			...
			else
			{
				...
				return Factory::getDbo()->updateObject('#__businessdirectory_'.$table, $object, 'id');
			}
		}
		return false;
	}
