...
/------------------------------------------------------------------------------------------------------*/
namespace JCB\Component\Businessdirectory\Administrator\View\Companies;
...
/**
 * Businessdirectory Html View class for the Companies
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	{
		ToolbarHelper::title(Text::_('COM_BUSINESSDIRECTORY_COMPANIES'), 'joomla');
		...
		$this->help_url = BusinessdirectoryHelper::getHelpUrl('companies');
	...
	protected function _prepareDocument(): void
	{
		...
		$this->getDocument()->setTitle(Text::_('COM_BUSINESSDIRECTORY_COMPANIES'));
		// add styles
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_BUSINESSDIRECTORY_COMPANY_NAME_LABEL'),
			'a.city' => Text::_('COM_BUSINESSDIRECTORY_COMPANY_CITY_LABEL'),
			'g.name' => Text::_('COM_BUSINESSDIRECTORY_COMPANY_COUNTRY_LABEL'),
