...
/------------------------------------------------------------------------------------------------------*/
namespace JCB\Component\Businessdirectory\Administrator\Table;
...
class CompanyTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_businessdirectory.company';
		...
		parent::__construct('#__businessdirectory_company', 'id', $db, $dispatcher);
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(Text::_('COM_BUSINESSDIRECTORY_COMPANY_ERROR_UNIQUE_ALIAS'));

				if ($table->published === -2)
				{
					$this->setError(Text::_('COM_BUSINESSDIRECTORY_COMPANY_ERROR_UNIQUE_ALIAS_TRASHED'));
				}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_businessdirectory.company.'.$this->id);
			$this->setRules($rules);
		}
	...
	protected function _getAssetParentId(Table $table = null, $id = null)
	{
		...
		// load the businessdirectory asset
		$assets->loadByName('com_businessdirectory');
